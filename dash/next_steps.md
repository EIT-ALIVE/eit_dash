...
git branch -M main
git remote add origin git@github.com:EIT-ALIVE/dash
```

## Push the initial commit to a new repo on GitHub

Go to
[https://github.com/organizations/EIT-ALIVE/repositories/new](https://github.com/organizations/EIT-ALIVE/repositories/new)
and create a new repository named `dash` as an empty repository, then push your commits to GitHub:
...
automatically ([here](git@github.com:EIT-ALIVE/dash/issues?q=author%3Aapp%2Fgithub-actions)). Resolve them to complete the
